...
from LibPeer.Discovery.DHT.kademlia.log import Logger
from LibPeer.Discovery.DHT.kademlia.protocol import KademliaProtocol
from LibPeer.Discovery.DHT.kademlia.utils import deferredDict, kademliaNodeId
from LibPeer.Discovery.DHT.kademlia.storage import ForgetfulStorage
from LibPeer.Discovery.DHT.kademlia.node import Node
from LibPeer.Discovery.DHT.kademlia.crawling import ValueSpiderCrawl
from LibPeer.Discovery.DHT.kademlia.crawling import NodeSpiderCrawl
...
class Server(object):
    ...
    def __init__(self, ksize=52, alpha=3, id=None, storage=None):
        """
        ...
        self.node = Node(id or kademliaNodeId(random.getrandbits(255)))
    ...
    def get(self, dkey, local = False):
        ...
        """
        # Get cached if local is true
        if local and self.storage.get(dkey) is not None:
